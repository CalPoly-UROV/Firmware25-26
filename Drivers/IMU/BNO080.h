...
#define BNO080_SPI_SCLK_PIN		GPIO_PIN_3
#define BNO080_SPI_SCLK_PORT	GPIOB
#define BNO080_SPI_SCLK_CLK		LL_AHB1_GRP1_PERIPH_GPIOB

#define BNO080_SPI_MISO_PIN		GPIO_PIN_4
#define BNO080_SPI_MISO_PORT	GPIOB
#define BNO080_SPI_MISO_CLK		LL_AHB1_GRP1_PERIPH_GPIOB

#define BNO080_SPI_MOSI_PIN		GPIO_PIN_5
#define BNO080_SPI_MOSI_PORT	GPIOB
#define BNO080_SPI_MOSI_CLK		LL_AHB1_GRP1_PERIPH_GPIOB

#define BNO080_SPI_CS_PIN		GPIO_PIN_4
#define BNO080_SPI_CS_PORT		GPIOA
#define BNO080_SPI_CS_CLK		LL_AHB1_GRP1_PERIPH_GPIOA

#define BNO080_PS0_WAKE_PIN		GPIO_PIN_1
#define BNO080_PS0_WAKE_PORT	GPIOE
#define BNO080_PS0_WAKE_CLK		LL_AHB1_GRP1_PERIPH_GPIOE

#define BNO080_RST_PIN			GPIO_PIN_2
#define BNO080_RST_PORT			GPIOE
#define BNO080_RST_CLK			LL_AHB1_GRP1_PERIPH_GPIOE

#define BNO080_INT_PIN			GPIO_PIN_3
#define BNO080_INT_PORT			GPIOE
#define BNO080_INT_CLK			LL_AHB1_GRP1_PERIPH_GPIOE

//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
#define CHIP_SELECT(BNO080)		HAL_GPIO_WritePin(BNO080_SPI_CS_PORT, BNO080_SPI_CS_PIN, 0)
#define CHIP_DESELECT(BNO080)	HAL_GPIO_WritePin(BNO080_SPI_CS_PORT, BNO080_SPI_CS_PIN, 1)

#define WAKE_HIGH()				HAL_GPIO_WritePin(BNO080_PS0_WAKE_PORT, BNO080_PS0_WAKE_PIN, 1)
#define WAKE_LOW()				HAL_GPIO_WritePin(BNO080_PS0_WAKE_PORT, BNO080_PS0_WAKE_PIN, 0)

#define RESET_HIGH()			HAL_GPIO_WritePin(BNO080_RST_PORT, BNO080_RST_PIN, 1)
#define RESET_LOW()				HAL_GPIO_WritePin(BNO080_RST_PORT, BNO080_RST_PIN, 0)
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////

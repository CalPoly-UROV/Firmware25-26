...
Returns 1 if last read was invalid
...
returns 0. Actual value of initialization needs to be retreived with another command

##### MPU_INIT_STATUS (0xB4)
returns mpu_init status
